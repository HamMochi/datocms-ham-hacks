  ...
  <Layout>
    <article className="sheet">
      <div className="sheet__body">
        ...
        <img src="https://cdn.discordapp.com/attachments/801387755858034699/819194266860519464/unknown.png" alt="SPST" height="300" width="400"/>
        ...
        <img src="https://cdn.thegeekpub.com/wp-content/uploads/2019/09/Types-of-Switches-Lots-of-different-types-of-switches-scaled.jpg" alt="Switches!" height="400" width="900"/>
        <p></p>
        <p> Here are a couple of common ones.</p>
        <p>Momentary Switch: Only switches to its "on" state while it is being pressed</p>
        <img src="https://www.shenzhen2u.com/image/cache/catalog/Buttons/Mini%20Push%20Button%20Switch-500x500.jpg" alt="Momentary Switch" height="300" width="300"/>
        <p>Latching Switch: Only needs to be pressed once to switch states and stays in that state until it is pressed again</p>
        <img src="https://images-na.ssl-images-amazon.com/images/I/61ICzMqkM1L._AC_SY355_.jpg" alt="Latching Switch" height="250" width="250"/>
      </div>
    </article>
  </Layout>
)
